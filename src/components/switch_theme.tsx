...
const MaterialUISwitch = styled(Switch)(({ theme }) => ({
  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& + .MuiSwitch-track': {
        opacity: 1,
        backgroundColor: thememode === 'dark' ? '#8796A5' : '#aab4be',
      },
    },
  },
  '& .MuiSwitch-thumb': {
    backgroundColor: thememode === 'dark' ? 'white' : '#001e3c',
    width: 32,
    height: 32,
    '&:before': {
      content: "''",
...
export default function SwitchTheme() {
  ...
  return (
      <>
        <FormControlLabel
          control={<MaterialUISwitch sx={{ m: 1 }} defaultChecked={isChecked} onClick={checkHandle}/>}
